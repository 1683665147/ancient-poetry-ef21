...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/ancient-poetry-ef21)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/ancient-poetry-ef21
```

A live public deployment of this template is available at [https://ancient-poetry-ef21.templates.workers.dev](https://ancient-poetry-ef21.templates.workers.dev)
